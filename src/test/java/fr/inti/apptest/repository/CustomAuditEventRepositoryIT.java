...
import fr.inti.apptest.config.audit.AuditEventConverter;
import fr.inti.apptest.domain.PersistentAuditEvent;
...
import static fr.inti.apptest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
