...
import fr.inti.apptest.domain.ProductCategory;
import fr.inti.apptest.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link fr.inti.apptest.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
